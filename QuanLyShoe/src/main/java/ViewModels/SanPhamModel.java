...
public class SanPhamModel {
    ...
    public SanPhamModel(String MaSP, HangEntity HangEntity, TheLoaiEntity TheLoaiEntity, SizeEntity SizeEntity, MauSacEntity MauSacEntity, String TenSP, Date NgayNhap, float Gia, int SoLuong, String Anh, int TrangThai) {
        this.MaSP = MaSP;
