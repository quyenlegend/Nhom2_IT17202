...
public class QLySize extends javax.swing.JDialog {
    ...
    private void loadDataToTableSize() {
        List<SizeModel> ds = sizeService.getProducts();
        DefaultTableModel dtm = (DefaultTableModel) this.tblSize.getModel();
        dtm.setRowCount(0);
        for (SizeModel product : ds) {
            Object[] rowData = {
                product.getMaSize(),
                product.getSize()
            };
    ...
    private SizeModel getSanPhamFromInput(){
        SizeModel qlSize = new SizeModel();
    ...
    private void btnTimKiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimKiemActionPerformed
        ...
        if(name.length() ==0){
            ...
            List<SizeModel> ds = sizeService.getProductByName(name);
            DefaultTableModel dtm = (DefaultTableModel) this.tblSize.getModel();
            dtm.setRowCount(0);
            for (SizeModel product : ds) {
                Object[] rowData = {
