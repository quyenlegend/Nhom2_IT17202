...
public class QLyHangSX extends javax.swing.JDialog {
    ...
    private void loadDataToTableHSX() {
        List<QLHangSX> ds = hangService.getProducts();
        DefaultTableModel dtm = (DefaultTableModel) this.tblHSX.getModel();
        dtm.setRowCount(0);
        for (QLHangSX product : ds) {
            Object[] rowData = {
                product.getMaHangSX(),
                product.getTenHang()
            };
    ...
    private QLHangSX getSanPhamFromInput(){
        QLHangSX qlHangSX = new QLHangSX();
    ...
    private void btnTimKiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimKiemActionPerformed
        ...
        if(name.length() ==0){
            ...
            List<QLHangSX> ds = hangService.getProductByName(name);
            DefaultTableModel dtm = (DefaultTableModel) this.tblHSX.getModel();
            dtm.setRowCount(0);
            for (QLHangSX product : ds) {
                Object[] rowData = {
